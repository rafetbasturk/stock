...
import type { DeliveryItemRow } from "./DeliveryItemsList";

export const getDeliveryItemColumns = (): ColumnDef<DeliveryItemRow>[] => [
  // ROW NUMBER
  {
    id: "row_number",
  ...
  // ORDER DATE
  {
    ...
    header: () => <div className="text-center">Sipariş Tarihi</div>,
    size: 100,
    meta: { filterTitle: "Sipariş Tarihi" },
    cell: ({ row }) => (
      <div className="text-center">
        {row.original.order_date.toLocaleDateString("tr-TR")}
      </div>
    ),
  },
